# Generated by Powerlevel10k configuration wizard on 2022-03-29 at 09:45 CDT.
...
() {
  ...
  # Add battery if on MacBook
  local os="$(uname)"
  [ "$os" = "Darwin" ] && POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS+=(battery)
  ...
  # Custom icon. (If on MacOS)
  [ "$os" = "Darwin" ] && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='λ'
  ...
  typeset -g POWERLEVEL9K_BATTERY_STAGES=('󰂎' '󰁺' '󰁻' '󰁼' '󰁽' '󰁾' '󰁿' '󰂀' '󰂁' '󰂂' '󰁹')
